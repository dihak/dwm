...
static Key keys[] = {
	...
	{ MODKEY, 		XK_s,		spawn,		SHCMD("st -e htop") },
	...
	{ MODKEY,			XK_v,		spawn,		SHCMD("{ killall xcompmgr || setsid xcompmgr & } ; xwallpaper --zoom ~/.config/wall.png") },
	...
	{ MODKEY|ShiftMask,		XK_v,		spawn,		{.v = mictoggle } },
